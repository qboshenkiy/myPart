...
<body>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('drawflow/draw/src/drawflow.css') ?>" />
    <link rel="stylesheet" type="text/css" href="<?= base_url('drawflow/draw/src/beautiful.css') ?>" />
    <link rel="stylesheet" type="text/css" href="<?= base_url('dawflow/draw/docs/') ?>" />
