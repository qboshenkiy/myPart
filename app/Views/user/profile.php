...
<div class="container">
    ...
    <style>
        * {
        ...
        .theme-black .profile-page .content__cover {
            background: linear-gradient(150deg, black 20%, #373737 100%);
        }
        ...
        .profile-page .content__avatar {
            ...
            background: rgb(0, 0, 0) url("<?= base_url('image/avatars/' . $avatar) ?>") center center no-repeat;
        ...
        .theme-black .profile-page .content__actions a:first-child {
            color: black;
        }
        ...
        .theme-black .profile-page .content__actions a:last-child {
            color: #373737;
        }
        ...
        .theme-black .profile-page .content__actions a:hover:first-child {
            background: black;
        }
        ...
        .theme-black .profile-page .content__actions a:hover:last-child {
            background: #373737;
        }
        ...
        .theme-black .profile-page .content__button .button {
            background: linear-gradient(100deg, black 10%, #373737 100%);
        }
        ...
        .theme-black .profile-page .bg div {
            background: linear-gradient(150deg, black 20%, #373737 100%);
        }
        ...
        .theme-black .theme-switcher-button {
        ...
        .theme-switcher-wrapper [data-theme="black"] {
    ...
    <div class="profile-page">
        <div class="content">
            ...
            <div class="content__title">
                <h1><?= $lastname ?> <?= $firstname ?></h1><span>New York, United States</span>
            </div>
            <div class="content__description" style="margin: 20px auto;">
                <div class="content__" style="text-align: left;">
        ...
        <div class="theme-switcher-wrapper" id="theme-switcher-wrapper"><span>Themes color</span>
            <ul>
                <li><em class="is-active" data-theme="black"></em></li>
        ...
        (() => {
            ...
            const themeSwiter = {
                ...
                init: function() {
                    ...
                    this.themes = ['theme-black', 'theme-purple', 'theme-green', 'theme-blue']
                    this.events()
                    this.start()
                },
